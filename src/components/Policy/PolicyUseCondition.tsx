...
const PolicyUseCondition: FC = () => {
  return (
    <div className="card-body overflow-y-scroll">
      <p className="text-xs">표준약관 제10023호 (2015. 6. 26. 개정)</p>
        ...
        info={[
          {
            ...
            headline: '제1조 목적',
            explain:
              '본 이용약관은 “Date Leaf”(이하 "사이트")의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.',
          },
          {
            id: 'use2',
            headline: '제2조 용어의 정의',
            explain: '본 약관에서 사용되는 주요한 용어의 정의는 다음과 같습니다.',
            lists: [
              {
                id: 'use2_0',
                title:
              ...
              {
                id: 'use2_1',
                title: '② 이용계약 : 사이트 이용과 관련하여 사이트와 회원간에 체결 하는 계약을 말합니다.',
              },
              {
                id: 'use2_2',
                title:
              ...
              {
                id: 'use2_4',
                title: '⑤ 운영자 : 서비스에 홈페이지를 개설하여 운영하는 운영자를 말합니다.',
              },
              {
                id: 'use2_5',
                title: '⑥ 해지 : 회원이 이용계약을 해약하는 것을 말합니다.',
              },
            ],
          },
          {
            id: 'use3',
            headline: '제3조 약관 외 준칙',
            explain:
              '운영자는 필요한 경우 별도로 운영정책을 공지 안내할 수 있으며, 본 약관과 운영정책이 중첩될 경우 운영정책이 우선 적용됩니다.',
          },
          {
            id: 'use4',
            headline: '제4조 이용계약 체결',
            lists: [
              {
                id: 'use4_0',
                title:
          ...
          },
          {
            ...
            lists: [
              ...
              {
                id: 'use8_3',
                title: '④ 회원은 운영자와 사이트 및 제3자의 지적 재산권을 침해해서는 안 됩니다.',
              },
            ],
          },
          {
            id: 'use9',
            headline: '제9조 서비스 이용 시간',
            lists: [
              {
                id: 'use9_0',
                title:
              ...
              },
              {
                ...
                child: [
                  {
                    id: 'use9_1_0',
                    title: '- 긴급한 시스템 점검, 증설, 교체, 고장 혹은 오동작을 일으키는 경우',
                  },
                  {
                    id: 'use9_1_1',
                    title: '- 국가비상사태, 정전, 천재지변 등의 불가항력적인 사유가 있는 경우',
                  },
                  {
                    id: 'use9_1_2',
                    title: '- 전기통신사업법에 규정된 기간통신사업자가 전기통신 서비스를 중지한 경우',
                  },
                  {
                    id: 'use9_1_3',
                    title: '- 서비스 이용의 폭주 등으로 정상적인 서비스 이용에 지장이 있는 경우',
                  },
                ],
              },
              {
          ...
          {
            id: 'use11',
            headline: '제11조 서비스 이용 제한',
            explain:
              '회원은 다음 각호에 해당하는 행위를 하여서는 아니 되며 해당 행위를 한 경우에 사이트는 회원의 서비스 이용 제한 및 적법한 조치를 할 수 있으며 이용계약을 해지하거나 기간을 정하여 서비스를 중지할 수 있습니다.',
            lists: [
              {
                id: 'use11_0',
                title: '① 회원 가입시 혹은 가입 후 정보 변경 시 허위 내용을 등록하는 행위',
              },
              {
                id: 'use11_1',
                title: '② 타인의 사이트 이용을 방해하거나 정보를 도용하는 행위',
              },
              {
                id: 'use11_2',
                title: '③ 사이트의 운영진, 직원 또는 관계자를 사칭하는 행위',
              },
              {
                id: 'use11_3',
                title: '④ 사이트, 기타 제3자의 인격권 또는 지적재산권을 침해하거나 업무를 방해하는 행위',
              },
              {
                id: 'use11_4',
                title: '⑤ 다른 회원의 ID를 부정하게 사용하는 행위',
              },
              {
                id: 'use11_5',
                title: '⑥ 다른 회원에 대한 개인정보를 그 동의 없이 수집, 저장, 공개하는 행위',
              },
              {
                id: 'use11_6',
                title: '⑦ 범죄와 결부된다고 객관적으로 판단되는 행위',
              },
              {
                id: 'use11_7',
                title: '⑧ 기타 관련 법령에 위배되는 행위',
              },
            ],
          },
          {
            id: 'use12',
            headline: '제12조 게시물의 관리',
            lists: [
              {
                id: 'use12_0',
                title:
              ...
              {
                id: 'use12_2',
                title: '③ 불량게시물의 판단기준은 다음과 같습니다.',
                child: [
                  {
                    id: 'use12_2_0',
                    title: '- 다른 회원 또는 제3자에게 심한 모욕을 주거나 명예를 손상하는 내용인 경우',
                  },
                  {
                    id: 'use12_2_1',
                    title: '- 공공질서 및 미풍양속에 위반되는 내용을 유포하거나 링크 시키는 경우',
                  },
                  {
                    id: 'use12_2_2',
                    title: '- 불법 복제 또는 해킹을 조장하는 내용인 경우',
                  },
                  {
                    id: 'use12_2_3',
                    title: '- 영리를 목적으로 하는 광고일 경우',
                  },
                  {
                    id: 'use12_2_4',
                    title: '- 범죄와 결부된다고 객관적으로 인정되는 내용일 경우',
                  },
                  {
                    id: 'use12_2_5',
                    title: '- 다른 이용자 또는 제3자와 저작권 등 기타 권리를 침해하는 경우',
                  },
                  {
                    id: 'use12_2_6',
                    title: '- 기타 관계 법령에 위배된다고 판단되는 경우',
                  },
                ],
              },
              {
          ...
          },
          {
            ...
            lists: [
              {
                id: 'use15_0',
                title: '① 본 사이트의 발생한 모든 민, 형법상 책임은 회원 본인에게 1차적으로 있습니다.',
              },
              {
                id: 'use15_1',
                title:
          ...
          },
          {
            ...
            lists: [
              ...
              {
                id: 'use16_2',
                title: '③ 운영자는 회원이 저장, 게시 또는 전송한 자료와 관련하여 일체의 책임을 지지 않습니다.',
              },
              {
                id: 'use16_3',
                title: '④ 운영자는 회원의 귀책 사유로 인하여 서비스 이용의 장애가 발생한 경우에는 책임지지 아니합니다.',
              },
              {
                id: 'use16_4',
                title:
          ...
          },
          {
            id: 'useAdd',
            headline: '부칙',
            explain: '이 약관은 <사이트 개설일>부터 시행합니다.',
          },
        ]}
      />
    </div>
...
export default PolicyUseCondition;
